                    ...
                    <article className="rooms-details__column rooms-details__columns--right">
                        <div className="rooms-details__booking">
                            <div className="rooms-details__booking-heading">
                                <h1 className="rooms-details__booking-heading">
                                    Hello
                                </h1>

                                <span className="rooms-details__column-heading-subtitle">
                                    From <span className="rooms-details__column-heading-subtitle-price">$150</span>/night
                                </span>
                            </div>
                            <div className="rooms-details__booking-calendar">
                                <div className="rooms-details__booking-calendar-heading">
                                    <h1 className="rooms-details__booking-calendar-title">
                                        Reserve:
                                    </h1>
                                    <span>
                                        From
